...
# Streamlit config
st.set_page_config(page_title="Finance Advisor Chatbot AI", page_icon="💰")
...
def handle_user_input(user_query):
    ...
    if not any(keyword in user_query.lower() for keyword in finance_keywords):
        return "I'm here to help with finance-related questions. Please ask about personal finance, corporate finance, public finance, international finance, behavioral finance, quantitative finance, esg finance, fintech, wealth management"
...
if "chat_history" not in st.session_state:
    st.session_state.chat_history = [
        AIMessage(content="Hello, I am Finance Advisor AI. How can I help you?"),
    ]
...
if st.button("Back to Finance App"):
